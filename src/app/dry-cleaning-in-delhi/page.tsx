            ...
            <section className="relative w-full min-h-screen flex flex-col items-center justify-center pt-28 sm:pt-32 pb-16 sm:pb-20">
                <Container>
                    <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                        ...
                        >
                            <span className="text-primary text-[13px] font-bold tracking-widest uppercase">Servicing All North Delhi Areas</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="text-primary">Across Delhi</span>
                        </h1>
