        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#E5BD43]/40 bg-[#E5BD43]/10 mb-6 backdrop-blur-md">
              ...
              <span className="text-[#E5BD43] text-xs font-bold tracking-widest uppercase">
                Premium Care
              </span>
            </div>
            ...
            <h2 className="text-2xl md:text-3xl font-light text-white mb-2">
              Delivered in{" "}
              <span className="font-bold text-[#4EF1BD]">24 Hours</span>.
            </h2>
            ...
            <div className="w-full pt-6 border-t border-[#ffffff]/10">
              <div className="flex flex-wrap items-center gap-y-4 gap-x-6 text-sm text-[#AEAEAF] font-medium">
                ...
                <span className="flex items-center gap-1">
                  <Droplets className="w-3 h-3 text-[#4EF1BD]" /> Eco-Friendly
                </span>
                <div className="hidden sm:block w-1 h-1 bg-[#6A6F76] rounded-full"></div>
          ...
          <div className="relative h-[500px] w-full hidden lg:block perspective-1000">
            ...
            <div className="absolute top-10 right-10 w-72 p-4 bg-[#0F1923] border border-[#03AE96]/30 rounded-2xl shadow-2xl z-20 transform rotate-[-5deg] hover:rotate-0 transition-transform duration-500 hover:z-30 group">
              <div className="bg-[#0A121B] rounded-xl h-48 mb-4 relative overflow-hidden flex items-center justify-center border border-white/5">
                ...
                <div className="absolute bottom-2 right-2 px-2 py-1 bg-[#4EF1BD] text-[#0A121B] text-xs font-bold rounded">
                  SPA MODE
                </div>
              </div>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[#AEAEAF] text-xs">
    ...
    <section className="py-24 bg-[#0F1923]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-white">
            Our Premium <span className="text-[#E5BD43]">Services</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {overviewServices.map((service, idx) => (
            <div
              key={idx}
              className="group relative bg-[#0A121B] rounded-2xl p-1 hover:-translate-y-2 transition-transform duration-300"
            >
              {/* Gradient Border Effect */}
              <div
                className={`absolute inset-0 bg-gradient-to-r ${service.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-sm`}
              ></div>

              <div className="h-full bg-[#0A121B] rounded-xl p-8 border border-[#ffffff]/5 relative overflow-hidden">
                {/* Background Pattern */}
                <div
                  className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${service.gradient} opacity-5 rounded-bl-[100px]`}
                ></div>
                ...
                <p
                  className={`text-xs font-bold uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r ${service.gradient} mb-4`}
                >
                  {service.subtitle}
                </p>
                ...
                >
                  Book Now{" "}
                  <ArrowRight
                    className={`w-4 h-4 text-transparent bg-clip-text bg-gradient-to-r ${service.gradient}`}
                  />
                </a>
              </div>
            </div>
  ...
  const details = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1517677208171-0bc5e259b33d?q=80&w=2070&auto=format&fit=crop",
      icon: Shirt,
      color: "#4EF1BD",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1489278542524-dea4616f1e75?q=80&w=2073&auto=format&fit=crop",
      icon: Wind,
      color: "#6D96FB",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1527513913476-fa6cb43e5300?q=80&w=2070&auto=format&fit=crop",
      icon: Sofa,
      color: "#A78BFA",
    },
  ];
    ...
    <section className="bg-[#0A121B] relative border-t border-[#ffffff]/5">
      {details.map((service, index) => (
        <div key={index} className="flex flex-col md:flex-row group">
          {/* Text Section */}
          <div
            className={`flex-1 p-12 lg:p-24 flex flex-col justify-center bg-[#0A121B] border-b md:border-b-0 border-[#ffffff]/5 ${index % 2 === 0 ? "order-1 md:order-1" : "order-1 md:order-2 bg-[#0F1923]"}`}
          >
          ...
          {/* Image Section */}
          <div
            className={`flex-1 relative overflow-hidden h-[400px] md:h-auto ${index % 2 === 0 ? "order-2 md:order-2" : "order-2 md:order-1"}`}
          >
    ...
    <section id="process" className="py-24 bg-[#0F1923] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-white">
            A Seamless Process{" "}
            <span className="text-[#E5BD43]">Designed for You</span>
          </h3>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, idx) => (
              ...
              >
                ...
                <h4 className="text-xl font-bold text-white mb-3 group-hover:text-[#4EF1BD] transition-colors">
                  {step.title}
                </h4>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-white">
            Trusted by the <span className="text-[#4EF1BD]">Best</span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, idx) => (
            <div
              key={idx}
              className="bg-[#0F1923] p-8 rounded-2xl border border-[#ffffff]/5 relative group hover:-translate-y-2 transition-transform duration-300"
            >
              {/* Quote Icon */}
              ...
              <div className="flex gap-1 mb-6">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-4 h-4 fill-[#E5BD43] text-[#E5BD43]"
                  />
                ))}
              </div>
              ...
              <div className="flex items-center gap-4 border-t border-[#ffffff]/10 pt-6">
                ...
                <div>
                  ...
                  <p className="text-[#AEAEAF] text-xs uppercase tracking-wide">
                    {review.role}
                  </p>
                </div>
              </div>
